...
You can build the binary version with the `go build github.com/esimov/asciibrot` command.

### Code example

To generate different output you can play with values in defined in the main function:
